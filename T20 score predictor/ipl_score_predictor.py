...
st.markdown("<h1 style='text-align: center; color: black; font-weight: bold; font-size: 36px;'> IPL Score Predictor 2024 </h1>", unsafe_allow_html=True)
...
st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("http://www.pixelstalk.net/wp-content/uploads/2016/09/All-White-Background-HD.jpg");
